...
declare function print(this: void, value: string): void;
declare function printTable(this: void, table: AnyTable): void;
...
declare namespace json {
  ...
  export function decodeFile(string: File): LuaTable;
  export function encode(table: LuaTable): string;
  export function encodePretty(table: LuaTable): string;
  export function encodeToFile(file: File, table: LuaTable): void;
